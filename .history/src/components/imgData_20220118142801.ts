const imgData: ({
    ...
    imgPath?: undefined;
        ...
        { num: 0, placeName: "凱旋門", country: "フランス共和国", url: "https://cdn.pixabay.com/photo/2020/07/23/21/34/arc-de-triomphe-5432392_1280.jpg", imgPath: '../img/arcDeTriomphe.jpeg',lo },
