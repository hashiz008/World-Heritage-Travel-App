const imgData: ({
    ...
    lng: undefined;
        ...
        // { num: 3, placeName: "ケルン大聖堂", country: "ドイツ連邦共和国", url: "https://cdn.pixabay.com/photo/2019/06/13/19/05/europe-4272297_1280.jpg", imgPath: '../img//cologneCathedral.webp',lat },
