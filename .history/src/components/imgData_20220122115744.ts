const imgData: ({
    ...
    lng: undefined;
        ...
        // { num: 4, placeName: "ストーンヘンジ", country: "イギリス", url: "https://cdn.pixabay.com/photo/2013/04/08/14/22/stonehenge-101801__480.jpg", imgPath: '../img/stonehenge.jpeg',lng:51.178 },
