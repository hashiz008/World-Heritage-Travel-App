const imgData: ({
    ...
    lng: undefined;
        ...
        { num: 16, placeName: "ヨセミテ国立公園", country: "アメリカ合衆国(カリフォルニア州)", wiki:"https://ja.wikipedia.org/wiki/カリフォルニア州", url: "https://cdn.pixabay.com/photo/2016/11/10/10/03/nature-1813903_1280.jpg", imgPath: '../img/y',lat:41.890,lng: 12.492},
