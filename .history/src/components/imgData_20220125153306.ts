const imgData: ({
    ...
    lng: undefined;
        ...
        { num: 18, placeName: "コルコバードの丘", country: "ブラジル連邦共和国", wiki:"https://ja.wikipedia.org/wiki/ブラジルの連邦共和国", url: "https://cdn.pixabay.com/photo/2017/12/11/12/14/colosseum-3012088_1280.jpg", imgPath: '../img/colosseum.webp',lat:41.890,lng: 12.492},
