const imgData: ({
    ...
    lng: undefined;
        ...
        { num: 29, placeName: "イスタンブール歴史地域", country: "トルコ共和国", placeData:"http3%82%BF%E3%83%AA%E3%82%A2", url: "https://cdn.pixabay.com/photo/2017/12/11/12/14/colosseum-3012088_1280.jpg", imgPath: '../img/colosseum.webp',lat:41.890,lng: 12.492},
