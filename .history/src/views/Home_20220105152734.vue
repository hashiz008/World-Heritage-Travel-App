<template>
    <div class="backImgDiv">
        <div class="backImg">
            ...
            <div class="startBtn opacity-3  flex justify-center">
                <router-link class="text-white rounded-full opacity-4 py-2 px-4 bg-gray-200 border border-blue-500" to="/about"
