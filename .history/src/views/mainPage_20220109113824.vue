    ...
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="btnBackDisplay bg-gray-400 h-24">
                ...
                <button @click="nums" value="2">2</button>
                <button @click="nums" value="3">3</button>
                <button @click="nums" value="4">4</button>
                <button @click="nums" value="5">5</button>
                <button @click="nums" value="6">6</button>
                <button @click="nums" value="7">7</button>
                <button @click="nums" value="8">8</button>
                <button @click="nums" value="9">9</button>
                <button @click="nums" value="0">0</button>
