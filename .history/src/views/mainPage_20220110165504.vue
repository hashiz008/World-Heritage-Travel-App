    ...
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="btnBackDisplay bg-gray-400 h-24">
                ...
                <button " @click="nums(this.id)" value="2">2</button>
                <button ee" @click="nums(this.id)" value="3">3</button>
                <button r" @click="nums(this.id)" value="4">4</button>
                <button e" @click="nums(this.id)" value="5">5</button>
                <button " @click="nums(this.id)" value="6">6</button>
                <button en" @click="nums(this.id)" value="7">7</button>
                <button ht" @click="nums(this.id)" value="8">8</button>
                <button e" @click="nums(this.id)" value="9">9</button>
                <button o" @click="nums(this.id)" value="0">0</button>
