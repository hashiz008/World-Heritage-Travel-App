    ...
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="btnBackDisplay bg-gray-400 h-24">
                ...
                <button @click="three(this.id)" value="3">3</button>
                <button @click="four(this.id)" value="4">4</button>
                <button @click="five(this.id)" value="5">5</button>
                <button @click="six(this.id)" value="6">6</button>
                <button @click="seven(this.id)" value="7">7</button>
                <button @click="eight(this.id)" value="8">8</button>
                <button @click="nine(this.id)" value="9">9</button>
                <button @click="zero(this.id)" value="0">0</button>
