<template>
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="imgNums mt-32 lg:mt-10 lg:ml-64">
            ...
            <div class="btnBackDisplay rounded-3xl bg-gray-400">
                ...
                <div class="resultBtn mr-40 mt-2">
                    <button class="rounded-xl text-xl bg-blue-500 w-16 h-7" @click="result">
                        Result
                    </button>
                </div>
                <div class="deleteBtn ml-20">
                    <button class="rounded-xl text-xl bg-blue-500 w-12 h-7" @click="result">
                        Del
                    </button>
                </div>
            </div>
