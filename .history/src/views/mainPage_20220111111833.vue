<template>
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="btnBackDisplay  rounded-3xl bg-gray-200">
                <!-- <input v-model="number" /> -->
                <div class="oneBtn pt-3">
                    <button
                        class="shadow-2xl onesBtn text-2xl rounded-full bg-blue-500 w-10 h-10"
                        @click="number += '1'"
                        value="one"
                    >
                        1
                ...
                <div class="resultBtn mr-32 mt-3">
                    <button
                        class="rounded-lg text-xl bg-blue-500 w-16 h-8"
                        @click="result"
                    >
                        Result
                    </button>
                </div>
                <div class="deleteBtn ml-32">
                    <button
                        class="rounded-lg text-xl bg-blue-500 w-12 h-8"
                        @click="result"
                    >
                        Del
                    </button>
