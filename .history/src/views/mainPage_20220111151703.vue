        ...
        <div class="backImg">
            ...
            >
                ...
                <div class="delBtnDisplay ml-32">
                    <button
                        class="delBtn rounded-lg font-medium text-3xl text-white border-2 border-blue-600 bg-blue-400 w-20 h-9"
                        @click="result"
                    >
                        Del
                    </button>
            ...
            <button
                class="text-white font-bold text-3xl rounded-full downloadBtn border-4 border-indigo-600 bg-indigo-300 h-20"
            >
                Download
            </button>
        </div>
