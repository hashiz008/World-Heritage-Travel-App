<template>
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="imgNums bg-gray-700 w-64 h-11 ml-40 lg:mt-10 lg:ml-64">
                <h1 class="text-white pr-32 pt-2 text-2xl font-bold">Number:{{ number }}</h1>
            </div>
...
<style scoped="lang">
@import url('https://fonts.googleapis.com/css2?family=Luxurious+Roman&family=M+PLUS+2:wght@700&family=Playfair+Display:wght@500&display=swap');
.backgroundDiv {
    margin-top: -60px;
}
.backImg {
