    ...
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            >
                ...
                <h4 class="pt-10 pr-48 font-semibold text-xl text-white">
                    by:{{ country }}
                </h4>
            </div>
            <div
    ...
    methods: {
        result() {
            ...
            for (let i=0; i<this.imgdata.length; i++) {
                if (this.imgdata[i].num == Number(this.number)) console.log(string = this.imgdata[i].img)
            }
        },
        del() {
