<template>
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            >
                <h1 class="pt-8 text-white pr-40 pt-1 text-2xl font-bold">
                    Number:{{ number }}
                </h1>
            </div>
            <div
                class="imgDataDisplay border-4 border-yellow-700 mt-5 bg-gray-800 w-64 h-20"
            >
                <div>
                    <h4 class="pt-2 text-white">{{ placeName }}</h4>
                </div>
                <h4 class="country pr-48 font-semibold text-xl text-white">
                    by:{{ country }}
                </h4>
            </div>
            <div
