<template>
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            >
                <h1 class="text-white pr-40 pt-1 text-xl font-bold">
                    Number:{{ number }}
                </h1>
            </div>
            <div
                class="imgDataDisplay border-4 border-yellow-700 mt-5 bg-gray-800 w-64 h-18"
            >
                <div>
                ...
                <div class="mt-8">
                    <h4 class="country pr-48 font-semibold text-2xl text-white">
                        by:{{ country }}
                    </h4>
                </div>
                <!-- <div class="mt-8"> -->
