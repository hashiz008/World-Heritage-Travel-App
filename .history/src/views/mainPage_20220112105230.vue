<template>
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div
                class="imgDataDisplay border-4 border-yellow-700 mt-5 bg-gray-800  h-18"
            >
                <!-- <div> -->
                ...
                <!-- </div> -->
                <div class="nation mt-8">
                    <h4 class="w-20 country pr-48 font-semibold text-2xl text-white">
                        by:{{ country }}
                    </h4>
                </div>
                <!-- <div class="mt-8"> -->
