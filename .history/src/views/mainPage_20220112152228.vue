    ...
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="downBtnDisplay">
                <a @click="download" :href="hrefs" :download="down">aa</a>
                <button
...
export default defineComponent({
    ...
    methods: {
        ...
        download():void {
            ...
            // console.log(img)
            console.log(this.hrefs = img)
            console.log(this.hrefs = img2)
            // console.log(this.down = this.hrefs)
            // console.log(this.down = img2)
        }
    },
});
</script>
