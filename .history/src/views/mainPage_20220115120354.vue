...
vue/no-deprecated-slot-attribute */ /* eslint-disable
vue/no-deprecated-slot-attribute */ /* eslint-disable
    ...
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="imageDiv imageDives">
                ...
                <div>
                    <twmplate :slot-scope="button-next" class="swiper-button-next"></twmplate>
                    <div :slot-scope="button-prev" class="swiper-button-prev"></div>
                </div>
            </div>
            <!-- <div class="Homebtn">
...
export default defineComponent({
    ...
    data() {
        return {
            swiOp: {
                speed: 10000, //スライドの切り替わりスピード
                spaceBetween: 10000, //各スライドの余白
    ...
    methods: {
        ...
        slider() {
            let display = document.querySelectorAll(".imageDives");
            let slideShow = document.createElement("div");
            let main = document.createElement("div"); //current
            let mainImg = document.createElement("img"); //current
            let extra = document.createElement("div"); //next
            slideShow.classList.add("overflow-hidden");
            main.classList.add("main");
            extra.classList.add("extra");
            // mainImg.src = this.imgdata[0].url
            let img = this.imgdata[0].url;
            mainImg.src = String(img);
            let sliderItems = document.querySelectorAll(".images");
            // main.append(sliderItems[0])
            main.append(mainImg);
            slideShow.append(main);
            slideShow.append(extra);
            console.log(display[0].append(slideShow));
            // let main: HTMLImageElement = document.createElement("img");
            // let extra = document.createElement("div");
            // main.setAttribute("data-index","0");
            // let index:number | null = Number(main.getAttribute("data-index"))
            // let num:number = Number(this.number)-1;
            // if (Number(index) == num) return;
            // let currentEle = this.imgdata[Number(index)];
            // //  if(Number(index)) animationType = "right";
            // //  else animationType = "left"
            // let nextEle = this.imgdata[num];
            // console.log(main.setAttribute("data-index",num.toString()))
            // console.log(main.src = nextEle)
        },
    },
});
</script>
