<template>
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div ref="target" class="imageDiv imageDives">
                <div class="main">
                    <img v-show="mainShow" class="image mainImages" :src="mainImg" />
                </div>
                <div class="extra">
                    <img v-show="extraShow" class="image extraImages" :src="img" />
                </div>
...
export default defineComponent({
    ...
    methods: {
        result(): void {
            ...
            this.extraImg = extraImage;
            this.placeName = placeName;
            this.country = nation;
            // this.slider(this.img);
        },
        del(): void {
        ...
        slider(images: string): void {
            ...
            // let current = this.imgdata[index].url;
            // console.log(Number(index) += Number(this.number))
            index += Number(this.number);
            let current = images;
            let currentImg: HTMLImageElement = document.createElement("img");
            let next = this.imgdata[index + 1].url;
            let nextImg: HTMLImageElement = document.createElement("img");
            currentImg.src = current as string;
            nextImg.src = next as string;
            main.setAttribute("data-index", index.toString());
            extra.setAttribute("data-index", index.toString());

            main.innerHTML = "";
            main.append(nextImg);
            extra.innerHTML = "";
            extra.append(currentImg);
            // console.log(extra);

            main.classList.add("expand-animation");
            extra.classList.add("deplete-animation"); //現在

            // console.log(Number(main.getAttribute("data-index"))+1 >= Number(extra.getAttribute("data-index")))
            if (Number(main.getAttribute("data-index"))) {
                sliderShow.innerHTML = "";
                sliderShow.append(extra);
                sliderShow.append(main);
            } else if (Number(extra.getAttribute("data-index"))) {
                sliderShow.innerHTML = "";
                sliderShow.append(main);
                sliderShow.append(extra);
            }
            ...
            // console.log(extra)
            // console.log(this.slideJump(this.number,this.imgdata))
            // console.log(main.getAttribute)
            // console.log(animationType)
        },
        // slideJump(steps:string,animationType:any) {
        // }
    },
});
</script>
