...
export default defineComponent({
    ...
    mounted() {
        // let lati = () => {
        //     console.log(this.imgdata.map((i) => i.lat));
        //     console.log("a");
        //     //   this.imgdata.map(i=>i.lat)
        // };
        // console.log(window.google);
        console.log(this.number);
        for (let i in this.imgdata) {
            console.log(Number(this.number) == this.imgdata[i].num);
        ...
        timer.addListener('click',(mapsMouseEvent: any)=>{
      return this.map(mapsMouseEvent);
    });
    },
    methods: {
        result(): void {
