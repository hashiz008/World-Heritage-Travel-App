...
export default defineComponent({
    ...
    mounted() {
        // this.result.addEventListener("click",function(e:any) {
        //     console.log(e)
        // })
        // this.result.onclick = function aa() {
        ...
        script.src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB-NbjJV8s44cWgNMS1f8CHH9rdyLwSx6c";
        script.async = true;
        console.log(document.head.appendChildscript)
        const map = new window.google.maps.Map(this.$refs.map, {
            center: {
                lat: 2.435,
                // lat: this.imgdata[0].lat,
                // lng: this.imgdata[0].lng,
                lng: 5.324,
            },
            zoom: 12,
        });
        ...
        // console.log(this.result(map.center))
