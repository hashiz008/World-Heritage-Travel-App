    ...
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="gooleMapDiv">
                <input id="search-bar" class="controls" type="text" placeholder="キーワード検索" v-model="keyword"  @change="placeAutocomplete">
...
export default defineComponent({
    ...
    mounted() {
        ...
        console.log(new window.google.maps.places.SearchBox(input))
