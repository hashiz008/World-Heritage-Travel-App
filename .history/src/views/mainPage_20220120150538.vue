<template>
  <script
  async
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB-NbjJV8s44cWgNMS1f8CHH9rdyLwSx6c&callback=initAutocomplete&libraries=places&channel=2"
></script>
    ...
    methods: {
        ...
        initAutocomplete() {
            ...
            map.addListener("bounds_changed", () => {
                searchBox.setBounds(
                    // map.getBounds() as window.google.maps.LatLngBounds
                    map.getBounds()
                );
            });
