<template>
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            ...
            <div class="shadow-iiner imageDiv">
                <img class=" images rounded-2xl border-8 border-yellow-700" :src="img" />
                <!-- <img class="images border-8 border-yellow-700" :src="img" /> -->
            </div>
            <div class="gooleMapDiv">
                <div ref="map" class="mapStyle"></div>
            </div>
            <!-- <div class="Homebtn">
