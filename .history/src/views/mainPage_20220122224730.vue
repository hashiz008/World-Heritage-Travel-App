    ...
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            <div class="inStyle">
                ...
                <div
                    id="nums"
                    class="btnBackDisplay border-4 border-yellow-800 rounded-3xl"
                >
...
@media screen and (min-width: 769px) {
    ...
    .btnBackDisplay {
        ...
        height: 205px;
        box-shadow: inset 8px 8px 8px 8px rgba(0, 0, 0, 0.06);
        background-image: url("https://www.wallpaper-box.com/smartphone/wp-content/uploads/2013/10/iPhone5148.jpg")
    }
    .downBtnDisplay {
        display: flex;
