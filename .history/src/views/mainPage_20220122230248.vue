            ...
            <div class="inStyle">
                ...
                >
                    ...
                    <div class="twoBtnDisplay">
                        <button
                            class="twoBtn font-medium text-3xl rounded-full text-white bg-gray-800 w-10 h-10"
                            @click="number += '2'"
                            value="2"
                        >
                            2
                    ...
                    <div class="threeBtnDisplay">
                        <button
                            class="threeBtn font-medium text-3xl rounded-full text-white bg-gray-800 w-10 h-10"
                            @click="number += '3'"
                            value="3"
                        >
                            3
                    ...
                    <div class="fourBtnDisplay">
                        <button
                            class="fourBtn font-medium text-3xl rounded-full text-white bg-gray-800 w-10 h-10"
                            @click="number += '4'"
                            value="4"
                        >
                            4
                    ...
                    <div class="fiveBtnDisplay">
                        <button
                            class="fiveBtn font-medium text-3xl rounded-full text-white bg-gray-800 w-10 h-10"
                            @click="number += '5'"
                            value="5"
                        >
                            5
                    ...
                    <div class="sixBtnDisplay mr-64">
                        <button
                            class="sixBtn font-medium text-3xl rounded-full text-white bg-gray-800 w-10 h-10"
                            @click="number += '6'"
                            value="6"
                        >
                            6
                    ...
                    <div class="sevenBtnDisplay">
                        <button
                            class="sevenBtn font-medium text-3xl rounded-full text-white bg-gray-800 w-10 h-10"
                            @click="number += '7'"
                            value="7"
                        >
                            7
                    ...
                    <div class="eightBtnDisplay mr-1">
                        <button
                            class="eightBtn font-medium text-3xl rounded-full text-white bg-gray-800 w-10 h-10"
                            @click="number += '8'"
                            value="8"
                        >
                            8
                    ...
                    <div class="nineBtnDisplay">
                        <button
                            class="nineBtn font-medium text-3xl rounded-full text-white bg-gray-800 w-10 h-10"
                            @click="number += '9'"
                            value="9"
                        >
                            9
                    ...
                    <div class="zeroBtnDisplay">
                        <button
                            class="zeroBtn font-medium text-3xl rounded-full text-white bg-gray-800 w-10 h-10"
                            @click="number += '0'"
                            value="0"
                        >
                            0
                    ...
                    <div class="resultBtnDisplay mr-32 mt-3">
                        <button
                            class="resultBtn rounded-lg font-medium text-2xl text-white bg-gray-800 w-20 h-9"
                            @click="result"
                        >
                            Result
                        </button>
                    ...
                    <div class="delBtnDisplay ml-32">
                        <button
                            class="delBtn rounded-lg font-medium text-2xl text-white bg-gray-800 w-20 h-9"
                            @click="del"
                        >
                            Del
                        </button>
