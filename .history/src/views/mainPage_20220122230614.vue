    ...
    <div class="backgroundDiv vw-100">
        <div class="backImg">
            <div class="inStyle">
                ...
                <div
                    id="imgNums"
                    class="imgNumsDisplay border-6 border-gray-400 bg-gray-800 w-64 h-12 ml-40 lg:mt-10 lg:ml-64"
                >
                    <h1
                ...
                <div
                    class="imgDataDisplay border-4 border-gray-400 mt-5 pt-1 bg-gray-800 h-20"
                >
                    <!-- <div> -->
