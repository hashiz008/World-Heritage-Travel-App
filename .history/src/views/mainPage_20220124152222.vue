...
@media screen and (min-width: 769px) and (max-width: 1119px) {
    ...
    .downloadBtn {
        margin-left: 400p____________________________________________________________________________________________________________________________________________________________________________________________________________________________x;
        margin-top: 90px;
        width: 25rem;
        box-shadow: 1px 15px 5px -5px rgba(0, 0, 0, 0.25);
    }
